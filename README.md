...
Redpanda Tiered Storage uses S3 as a data storage layer, and intelligently caches data on local disks to maintain performance benefits. This demo uses [MinIO](https://min.io/) for local S3-compatible object storage.
